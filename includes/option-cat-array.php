	...
	$ann_options = array(
					...
					'sections'	=>	array(
							...
							array(
								...
								'title'			=>	'Fonts',
								'id'			=>	'fonts',
								'desc'			=>	'The Desc for fonts section.',
								'callback_func'	=>	'annframe_sec_fonts_setting',
								'css_class'		=>	$textdomain.'-sec-fonts-setting',
								),
								array(

								'title'			=>	'Footer Settings',
								'id'			=>	'footer_settings',
								'desc'			=>	'The Desc for Footer Settings section.',
								'callback_func'	=>	'annframe_sec_footer_setting',
								'css_class'		=>	$textdomain.'-sec-footer-setting',
								),
					...
					'settings_fields'	=>	array(
						...
						array(
							...
							'id' 		=>	'header_fonts',
							'type' 		=>	'textarea',
							'desc' 		=>	'Choose a font from fonts collection',
							'std'		=>	'Default fonts',
							'section'	=>	'fonts',
							'menu_slug' => 	'annSettings',
							'callback'	=>	'annframe_header_fonts_callback',
						),
						array(
							...
							'id' 		=>	'footer_credits',
							'type' 		=>	'select',
							'desc' 		=>	'Type footer credits here',
							'std'		=>	'Footer Credits',
							'section'	=>	'footer_settings',
							'menu_slug' => 	'annSettings',
							'callback'	=>	'annframe_footer_settings_callback',
						),
					),
	);
