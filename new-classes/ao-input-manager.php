...
class AO_Input_Manager
{
    ...
    public static function init() 
    {
        if (null === self::$_instance ) {
            self::$_instance = new AO_Input_Manager();
        }
    ...
    public function addPage( $page = array() ) 
    {
        ...
        //if( ! array_key_exists( 'slug', $page ) || $page['slug'] == '' || $page['slug'] == null ) return;
        //if( ao_is_not_valid_key( 'slug', $page ) || ao_is_null( $page['slug']) ) return;

        if ($this->pages[ $page['slug'] ] instanceof AO_Page_Manager ) {
